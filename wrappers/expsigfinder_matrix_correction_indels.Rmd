---
title: "ExpSigfinder matrix correction - indels"
...
write.csv(mut_matrix_calcs_table_dropped, "mutation_matrix_indels_low_raw_calls.csv")
...
sign_mutation_matrix_indels_coverage_corrected <- matrix(nrow = 83)
...
for (i in 1:nrow(mut_matrix_calcs_table_keep)) {
  ...
  sign_mutation_matrix_indels_coverage_corrected <- cbind(sign_mutation_matrix_indels_coverage_corrected, cor_col)
  colnames(sign_mutation_matrix_indels_coverage_corrected)[ncol(sign_mutation_matrix_indels_coverage_corrected)] <- sample_i
}

#add first col
sign_mutation_matrix_indels_coverage_corrected[,1] <- sign_mutation_matrix[,1]
colnames(sign_mutation_matrix_indels_coverage_corrected)[1] <- "MutationType"
...
write.csv(sign_mutation_matrix_indels_coverage_corrected, "sign_mutation_matrix_indels_coverage_corrected.csv", row.names = FALSE)
```
