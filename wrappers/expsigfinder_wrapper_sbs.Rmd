...
This is a script to implement ExpSigfinder (https://github.com/xqzou/ExpSigfinder), based on functions written by Zoe Zou (2022).
...
library(devtools)
install_github("EllieDunstone/ExpSigfinder")
```
