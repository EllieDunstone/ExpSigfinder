...
This script is part of ExpSigfinder (https://github.com/EllieDunstone/ExpSigfinder), based on functions written by Zoe Zou (2022). It should be run before the scripts for extracting signatures, in order to correct the input matrix.
...
We can set a threshold below which to drop samples - these samples have evidence for excess mutagenesis, but insufficient raw mutation calls to assess the signature.
